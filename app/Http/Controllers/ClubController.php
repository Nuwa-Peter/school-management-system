...
class ClubController extends Controller
{
    ...
    {
        $clubs = Club::with('teacherInCharge')->withCount('members')->latest()->get();
        return view('activities.clubs.index', compact('clubs'));
    }
    ...
    public function create(): View
    {
        ...
        return view('activities.clubs.create', compact('teachers'));
    }
    ...
    {
        $club->load(['teacherInCharge', 'members']);
        $students = User::where('role', 'student')->orderBy('last_name')->get();
        return view('activities.clubs.show', compact('club', 'students'));
    }
    ...
    {
        $teachers = User::where('role', 'teacher')->orderBy('last_name')->get();
        return view('activities.clubs.edit', compact('club', 'teachers'));
    }
     ...
     */
    public function removeMember(Club $club, User $student): RedirectResponse
    {
        $club->members()->detach($student->id);
